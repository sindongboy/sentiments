...
public class Prop {
    ...
    // local test
    //public static final String HADOOP_CONF_PATH = "/usr/local/Cellar/hadoop/2.7.2/libexec/etc/hadoop";
    ...
    /** Dictionary TMP */
    public static final String REP_DICT_TMP = "REP_DICT_TMP";
    ...
    /** category mapping */
    public static final String CAT_MAP = "CAT_MAP";
