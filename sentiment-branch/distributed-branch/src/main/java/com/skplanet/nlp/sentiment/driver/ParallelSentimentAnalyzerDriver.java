...
import com.skplanet.nlp.sentiment.mapper.ParallelSentimentAnalyzerMapper;
import com.skplanet.nlp.sentiment.reducer.ParallelSentimentAnalyzerReducer;
...
/**
 * Sentiment Analyzer Driver ( MapReduce Implementation )
 *
 * it loads documents from HIVE table and do sentiment analysis.
 *
 * @author Donghun Shin / donghun.shin@sk.com
 * @since 3/11/16
 *
 */
public class ParallelSentimentAnalyzerDriver extends Configured implements Tool {

    private static final Logger LOGGER = Logger.getLogger(ParallelSentimentAnalyzerDriver.class.getName());
    ...
    public int run(String[] args) throws Exception {
        ...
        // input partition filter [ yyyymmdd ]
        String inputPartition = args[2];
        */
        // set queuename
        ...
        job.setJarByClass(ParallelSentimentAnalyzerDriver.class);
        job.setMapperClass(ParallelSentimentAnalyzerMapper.class);
        job.setReducerClass(ParallelSentimentAnalyzerReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new ParallelSentimentAnalyzerDriver(), args);
