...
java -Xmx4G -Dfile.encoding=UTF-8 -cp ${DEP}:${TARGET}:${CONFIG}:${NLP_CONFIG}:${NLP_DICT}:${DICTIONARY}:${SYSDICT} com.skplanet.nlp.sentiment.driver.SentimentServer -c ${category} -p ${port}
