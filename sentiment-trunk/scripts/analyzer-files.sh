...
TARGET="../target/sentimentAnalyzer-core-1.3.5.jar"
...
java -Xmx4G -Dfile.encoding=UTF-8 -cp ${CP} ${PACKAGE}.driver.SentimentAnalyzerDriver -c ${category} -i ${input} -o ${output}
