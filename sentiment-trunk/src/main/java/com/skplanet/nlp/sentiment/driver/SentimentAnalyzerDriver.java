...
/**
 * Sample Sentiment Analyzer Driver
 *
 * input : path to the input files
 * output : path to the output files
 *
 * @author Donghun Shin / donghun.shin@sk.com
 */
final class SentimentAnalyzerDriver {
    private static final Logger LOGGER = Logger.getLogger(SentimentAnalyzerDriver.class.getName());
    ...
    private SentimentAnalyzerDriver() {
