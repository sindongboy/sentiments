...
public class SentimentAnalyzer {
     ...
     * default constructor
     */
    public SentimentAnalyzer(SentimentDict dict) {
        collocation = Collocation.getInstance();
        nlp = NLPUtils.getInstance();
     ...
     */
    public List<Sentiment> find(String text) {
        ...
        // collocation
        Pair[] tmpColloc = collocation.process(this.nlp.getMorphs(text.toLowerCase()), this.nlp.getPOSTags(text.toLowerCase()), 3, true);
        if (tmpColloc == null) {
            return sentiments;
        }
    ...
    public List<Sentiment> findNullAttributeSentiment(String[] sentToks, String[] sentTags,
        ...
        String[] nToks = nlp.getMorphs("null");
        String[] nTags = nlp.getPOSTags("null");
        Attribute nullAttribute = (Attribute) this.attributeDict.match(SentimentDict.createKey(nToks, nTags));
